              ...
              <div className="flex justify-center mt-6">
                <span className="inline-flex rounded-md shadow">
                  <Link href="/editor">
                    <a
                      href="#"
                      className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-emerald-500 bg-white hover:text-emerald-400"
                    >
                      Get Started
                    </a>
                  </Link>
        ...
        <div className="bg-gray-800">
          <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
            <h2 className="text-center text-gray-400 text-sm font-semibold tracking-wide">
              Made with &#9825; by{' '}
              <a className="hover:text-emerald-500" href="https://twitter.com/katherinecodes">
                Katherine Peterson
              </a>
            </h2>
          </div>
